...
<!-- jQuery sticky menu -->
<script src="/ecommerce/res/store/js/owl.carousel.min.js"></script>
<script src="/ecommerce/res/store/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/ecommerce/res/store/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/ecommerce/res/store/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/ecommerce/res/store/js/bxslider.min.js"></script>
<script type="text/javascript" src="/ecommerce/res/store/js/script.slider.js"></script>
</body>
</html>